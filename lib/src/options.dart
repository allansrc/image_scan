...
class CropAspectRatio {
  ...
  @override
  bool operator ==(other) =>
      identical(this, other) || other is CropAspectRatio && this.ratioX == other.ratioX && this.ratioY == other.ratioY;
}
...
class AndroidUiSettings {
  ...
  Map<String, dynamic> toMap() => {
        ...
        'android.active_controls_widget_color': int32(this.activeControlsWidgetColor?.value),
