...
public class ImageScanDelegate implements PluginRegistry.ActivityResultListener {
    private final Activity activity;
    private MethodChannel.Result pendingResult;
    private FileUtils fileUtils;

    public ImageScanDelegate(Activity activity) {
	...
	if("png".equals(compressFormat)){
        outputFile = new File(outputDir, "image_scan_" + (new Date()).getTime() + ".png");
	} else {
		outputFile = new File(outputDir, "image_scan_" + (new Date()).getTime() + ".jpg");
	}
