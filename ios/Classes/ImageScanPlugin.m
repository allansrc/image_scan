#import "ImageScanPlugin.h"
#import <TOCropViewController/TOCropViewController.h>
#import <UIKit/UIKit.h>
#import <MobileCoreServices/MobileCoreServices.h>
#import <Photos/Photos.h>

@interface ImageScanPlugin() <TOCropViewControllerDelegate>
@end

@implementation ImageScanPlugin {
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"plugins.f-team.dev/image_scan"
            binaryMessenger:[registrar messenger]];
  UIViewController *viewController = [UIApplication sharedApplication].delegate.window.rootViewController;
  ImageScanPlugin* instance = [[ImageScanPlugin alloc] initWithViewController:viewController];
...
- (void)cropViewController:(TOCropViewController *)cropViewController didCropToImage:(UIImage *)image withRect:(CGRect)cropRect angle:(NSInteger)angle
{
    ...
    if ([@"png" isEqualToString:_compressFormat]) {
        ...
        tmpFile = [NSString stringWithFormat:@"image_scan_%@.png", guid];
    } else {
        data = UIImageJPEGRepresentation(image, _compressQuality);
        tmpFile = [NSString stringWithFormat:@"image_scan_%@.jpg", guid];
    }
